...
//Imports juego
import { GameComponent, winnerDialog, tryAgainDialog, loserDialog } from './game/game.component';
...
export const routingComponents = [HomepageComponent, loginDialog, registerDialog, PrincipalPageComponent, GameComponent, winnerDialog, tryAgainDialog, loserDialog, RoomSelectorComponent, ProfileComponent, editDialog, RankingComponent, PageNotFoundComponent]
